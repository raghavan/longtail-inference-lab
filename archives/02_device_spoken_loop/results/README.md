...
**Zero published device measurements.**

As of September 12, 2026, no hardware purchase or measured Jetson run is recorded here. The laptop controller and local app have documented development checks. Those checks and any private pilot logs do not establish device performance. Every device number is a target, a budget, or a threshold until a dated results folder appears here.
