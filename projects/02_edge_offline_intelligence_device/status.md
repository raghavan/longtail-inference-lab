...
The [Jetson shopping list and restart checklist](hardware/portable_procurement.md) is ready. Purchasing is on hold until the next owner session, planned for next week. The first hardware stage is mains-powered speech input and output with a physical listening button; screen, battery, and portable enclosure are deferred. Eight items across Arrow, DigiKey, and B&H total $487.55 before tax, shipping, and tariffs at the September 13 checkpoint. Arrow is the preferred source for the $399 complete Orin Nano Super 8 GB kit; the storage choice is a SanDisk Extreme 128 GB card. The prepared cart reached account sign-in, with no order, payment, or reservation completed. Recheck every price and availability before resuming checkout. The [budget](hardware/bill_of_materials.md) preserves the $1,000 first-year ceiling, a possible $99 distribution renewal, and a provisional $100 checkout allowance. Jetson software, exact models, voice quality, memory headroom, latency, and the future battery target remain unmeasured.
