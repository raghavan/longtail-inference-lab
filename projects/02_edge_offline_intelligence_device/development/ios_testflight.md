...
The physical-device release compiled and reached code signing; owner keychain approval is pending. App Store Connect sign-in/registration, distribution signing, upload, processing, and owner TestFlight availability remain pending. No TestFlight delivery is claimed. The [iPhone guide](../software/apple/iOS/README.md) records reproducible build and delivery steps.
